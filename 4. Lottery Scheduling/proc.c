...
struct pstat ps; //variable of the pstat structure
...
//sets a ticket number for a process
int
settickets(int n)
{
  struct proc *p = myproc();
...
//Function getpinfo to return the process information
int
...
//rewrite the scheduler to  use lottery scheduling  algorithm
void
scheduler(void)
{
  struct proc *p;
